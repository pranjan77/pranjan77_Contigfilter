package pranjan77_ContigFilter::pranjan77_ContigFilterClient;
...
pranjan77_ContigFilter::pranjan77_ContigFilterClient
...
sub new
{
    ...
    my $self = {
	client => pranjan77_ContigFilter::pranjan77_ContigFilterClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
<pre>
$params is a pranjan77_ContigFilter.FilterContigsParams
$return is a pranjan77_ContigFilter.FilterContigsResults
FilterContigsParams is a reference to a hash where the following keys are defined:
	workspace has a value which is a pranjan77_ContigFilter.workspace_name
	contigset_id has a value which is a pranjan77_ContigFilter.contigset_id
...
FilterContigsResults is a reference to a hash where the following keys are defined:
	...
	new_contigset_ref has a value which is a pranjan77_ContigFilter.ws_contigset_id
...
# Authentication: required
	...
	method => "pranjan77_ContigFilter.filter_contigs",
	params => \@args,
    });
    if ($result) {
	if ($result->is_error) {
...
<pre>
$params is a pranjan77_ContigFilter.FilterContigsMaxParams
$return is a pranjan77_ContigFilter.FilterContigsResults
...
# Authentication: required
    ...
    my $result = $self->{client}->call($self->{url}, $self->{headers}, {
	method => "pranjan77_ContigFilter.filter_contigs_max",
	params => \@args,
    });
    if ($result) {
	if ($result->is_error) {
...
sub version {
    my ($self) = @_;
    my $result = $self->{client}->call($self->{url}, $self->{headers}, {
        method => "pranjan77_ContigFilter.version",
        params => [],
    });
    if ($result) {
        if ($result->is_error) {
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for pranjan77_ContigFilter::pranjan77_ContigFilterClient\n";
    }
    if ($sMajor == 0) {
        warn "pranjan77_ContigFilter::pranjan77_ContigFilterClient version is $svr_version. API subject to change.\n";
    }
}
...
package pranjan77_ContigFilter::pranjan77_ContigFilterClient::RpcClient;
