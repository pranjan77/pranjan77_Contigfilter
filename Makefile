SERVICE = pranjan77_contigfilter
SERVICE_CAPS = pranjan77_ContigFilter
SPEC_FILE = pranjan77_ContigFilter.spec
URL = https://kbase.us/services/pranjan77_contigfilter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
